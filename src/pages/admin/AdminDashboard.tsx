  ...
  return (
    <AdminLayout>
      <div className="admin-page">
        ...
        {/* Top Albums */}
        <div className="dashboard-widget mb-2">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '1rem' }}>
                    <div className="dashboard-widget" style={{ padding: '1rem' }}>
                      <div className="dashboard-card-label">Total Revenue</div>
                      {revenueBreakdown && <div className="dashboard-card-value" style={{ fontSize: '1.6rem' }}>{formatCurrency(revenueBreakdown.summary.totalRevenue)}</div>}
                    </div>
                    <div className="dashboard-widget" style={{ padding: '1rem' }}>
                      <div className="dashboard-card-label">Total Cost</div>
                      {revenueBreakdown && <div className="dashboard-card-value" style={{ fontSize: '1.6rem', color: '#f59e0b' }}>{formatCurrency(revenueBreakdown.summary.totalCost)}</div>}
                    </div>
                    <div className="dashboard-widget" style={{ padding: '1rem' }}>
                      <div className="dashboard-card-label">Total Profit</div>
                      {revenueBreakdown && <div className="dashboard-card-value" style={{ fontSize: '1.6rem', color: '#10b981' }}>{formatCurrency(revenueBreakdown.summary.totalProfit)}</div>}
                    </div>
                    <div className="dashboard-widget" style={{ padding: '1rem' }}>
                      <div className="dashboard-card-label">Items Sold</div>
                      {revenueBreakdown && <div className="dashboard-card-value" style={{ fontSize: '1.6rem', color: 'var(--text-primary)' }}>{revenueBreakdown.summary.totalItems}</div>}
                    </div>
                  </div>
                    ...
                    {revenueBreakdown && revenueBreakdown.byCategory.length === 0 ? (
                      ...
                      <div style={{ overflowX: 'auto' }}>
                        <table className="data-table">
                          ...
                          <tbody>
                            {revenueBreakdown && revenueBreakdown.byCategory.map((row) => (
                              <tr key={row.category}>
                                <td>{row.category}</td>
                  ...
                  <div className="dashboard-widget">
                    ...
                    {revenueBreakdown && revenueBreakdown.byAlbum.length === 0 ? (
                      ...
                      <div style={{ overflowX: 'auto' }}>
                        <table className="data-table">
                          ...
                          <tbody>
                            {revenueBreakdown && revenueBreakdown.byAlbum.map((row) => (
                  ...
                  <div className="dashboard-widget">
                    ...
                    {revenueBreakdown && revenueBreakdown.byProduct.length === 0 ? (
                      ...
                      <div style={{ overflowX: 'auto' }}>
                        <table className="data-table">
                          ...
                          <tbody>
                            {revenueBreakdown && revenueBreakdown.byProduct.map((row) => (
                  ...
                  <div className="dashboard-widget">
                    ...
                    {revenueBreakdown && revenueBreakdown.bySize.length === 0 ? (
                      ...
                      <div style={{ overflowX: 'auto' }}>
                        <table className="data-table">
                          ...
                          <tbody>
                            {revenueBreakdown && revenueBreakdown.bySize.map((row) => (
