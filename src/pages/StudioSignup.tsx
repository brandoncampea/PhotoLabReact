  ...
  return (
    <div className="main-content dark-bg">
      <div className="auth-container">
        <div className="auth-card auth-box-maxwidth">
          <h1 className="auth-title gradient-text">Create Your Studio</h1>
          ...
          <div className="plan-section">
            <h3 style={{ margin: '0 0 0.4rem 0', color: '#e0e0e0', fontWeight: 700 }}>Select Your Plan</h3>
          ...
          <form onSubmit={handleSubmit}>
            <h3 style={{ margin: '0.5rem 0 0.75rem 0', color: '#a78bfa', fontWeight: 700, fontSize: '0.9rem', textTransform: 'uppercase', letterSpacing: '0.06em' }}>Studio Information</h3>
            ...
            <h3 style={{ margin: '1rem 0 0.75rem 0', color: '#a78bfa', fontWeight: 700, fontSize: '0.9rem', textTransform: 'uppercase', letterSpacing: '0.06em' }}>Admin Account</h3>
            <div className="form-row-margin">
          ...
          <p className="signup-login-link">
            ...
            <a href="/login" className="signup-login-link-a">Log in here</a>
          </p>
        </div>
      </div>
    </div>
